...
manifest=json.loads((art/'asset-manifest.json').read_text());changed=json.loads((art/'Source/C10/changed-assets.json').read_text())
for e in manifest:
...
(art/'material-readback-c10.json').write_text(json.dumps(report,indent=2))
...
unreal.log('C10_GEOMETRY_IMPORTED')
