...
BRAIN=organ('Brain','BRAIN',[8050,0,220],
 ...
 [door(-1550,0,500,250),door(-450,-415,300,400,1),door(-450,415,300,400,1)],'lavender',kind='brain')
...
PATHS=[
 ...
 path('Crown ascent',[(5160,0,0),(5700,0,80),(6260,0,220),(6670,0,220)],540),
...
STATIONS=[
 ...
 dict(name='BRAIN',title='Awareness garden',position=[7720,0,283],kind='brain',palette='lavender'),
...
THOUGHTS=[[7340,-970,283],[8520,-900,283],[7350,950,283],[8550,940,283]]
